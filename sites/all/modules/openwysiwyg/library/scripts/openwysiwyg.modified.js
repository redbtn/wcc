 ...
 *
 * $Id: openwysiwyg.modified.js,v 1.7 2009/06/18 13:42:29 thenicespider Exp $
 * $Revision: 1.7 $
 *
...
var WYSIWYG = {
 ...
 Settings: function() {
  ...
  this.Width     = "500px"; // Default width and height (use px or %)
  this.Height    = "200px";
  ...
  this.NoValidBrowserMessage   = "openWYSIWYG does not support your browser."; // if browser is not supported
  ...
  this.Opener = "admin.asp"; // Page that opened the WYSIWYG (Used for the return command)
  this.ImagePopupFile   = ""; // Insert image implementation
  this.ImagePopupWidth  = 0;
  this.ImagePopupHeight = 230;
  this.Toolbar = new Array(); // Holds the available buttons displayed on the toolbar of the editor
  this.Toolbar[0] = new Array(
   "fonts", "fontsizes", "headings", "bold", "italic", "underline", "strikethrough","seperator", 
   "forecolor", "backcolor", "seperator", "justifyfull", "justifyleft", "justifycenter", "justifyright", "seperator", 
   "unorderedlist", "orderedlist", "outdent", "indent"
  );
  this.Toolbar[1] = new Array(
   // "save", //Wendy: drupal no need this
   // "return", // return button disabled by default
   "seperator", "subscript", "superscript", "seperator", "cut", "copy", "paste","removeformat",
   "seperator", "undo", "redo", "seperator", "inserttable", "insertimage", "createlink", 
   "seperator", "preview", "print", "seperator", "viewSource", "maximize", "seperator", "help"
 );
